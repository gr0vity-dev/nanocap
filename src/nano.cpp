...
void nano_t::message_header_t::_read() {
    ...
    if (!(magic() == std::string("\x52", 1))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x52", 1), magic(), _io(), std::string("/types/message_header/seq/0"));
    }
...
std::string nano_t::const_block_zero() {
    ...
    m_const_block_zero = m__io->read_bytes(32);
